...
For more information about the maximum number of supported worker nodes in a {hcp-title} cluster, see xref:../../rosa_planning/rosa-hcp-limits-scalability.adoc#rosa-hcp-limits-scalability[{hcp-title} limits and scalability].
