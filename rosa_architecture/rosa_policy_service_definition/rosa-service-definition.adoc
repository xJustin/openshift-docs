...
For more information about the maximum number of supported worker nodes in a {rosa-classic} cluster, see xref:../../rosa_planning/rosa-limits-scalability.adoc#rosa-limits-scalability[Limits and scalability].
